...
const (
	PubSub_Subscribe_FullMethodName = "/grpc.v1.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/grpc.v1.PubSub/Publish"
)
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "docs/proto/pubsub/v1/pubsub.proto",
}
